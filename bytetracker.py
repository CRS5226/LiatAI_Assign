...
OUTPUT_PATH = "./output_bytetracker.mp4"
TRACKER_CONFIG = "bytetrack.yaml"  # BoT-SORT tracking config

PERSON_CLASS = 0
BALL_CLASS = 32  # Adjust if needed
DRAW_TRAILS = False
MAX_TRAIL_LENGTH = 30
SHOW_BOUNDING_BOXES = True  # Added bounding box toggle
...
while cap.isOpened():
    ...
    out.write(frame)
    cv2.imshow("YOLOv11 + ByteTracker", frame)
